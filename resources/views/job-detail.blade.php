    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="{{ route('home') }}">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{ route('jobDetail') }}"> Job Details</a></p>
            </div>											
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-center d-flex">
            <div class="col-lg-8 post-list">
                ...
                <div class="single-post job-experience">
                    ...
                    <ul>
                        <li>
                            <img src="{{ asset('public/themes/img/pages/list.jpg') }}" alt="">
