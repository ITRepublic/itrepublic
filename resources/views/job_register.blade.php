    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <a href="{{ route('job') }}" class="text-white"> Job post</a>
                <span class="lnr lnr-arrow-right"></span>
                
                <a class="nav-link text-white" href="{{ url('job_registration') }}">
                Create new job here
                                </a>
                </p>											
        </div>
                ...
                <div class="single-post d-flex flex-row">
                    ...
                    <div class="details">
                        <div class="title d-flex flex-row justify-content-between">
                            <div class="titles">
                                <a href="{{ route('job_detail') }}"><h4>Creative Art Designer</h4></a>
                ...
                <div class="single-slidebar">
                    ...
                    <div class="blog-list">
                        <div class="single-blog " style="background:#000 url(public/themes/img/blog1.jpg);">
                            <a href="{{ route('job_detail') }}"><h4>Home Audio Recording <br>
                            For Everyone</h4></a>
