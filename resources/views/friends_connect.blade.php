      ...
      <div id="ember731" class="sticky stuck ember-view" style="height: 778px; width: 216px; margin: 0px auto;">          
        <div class="left-rail-container">
          <div id="ember732" class="mn-connections-summary container-with-shadow ember-view">
            <div class="pt4">
              <div id="ember733" class="mn-origami-rail-card--fade-in ember-view">
                <section id="ember734" class="mn-origami-rail-card artdeco-card ember-view">
                  ...
                  <hr class="artdeco-divider mv0">
                  <div class="mn-origami-rail-card__summary">
                    <a data-control-name="companies" href="/feed/following/?filterType=company" id="ember909" class="js-mn-origami-rail-card__company-count link-without-hover-state ember-view">              
                      <h3 class="mn-origami-rail-card__count t-20 t-black t-normal" aria-label="See 6 companies you follow">
                        6
                      </h3>
                    </a>
                    <h3 class="t-16 t-black t-normal" aria-hidden="true">
                    ...
                    <a data-control-name="companies" href="/feed/following/?filterType=company" id="ember910" class="js-mn-origami-rail-card__company-count link-without-hover-state ember-view">              
                      <div>
                        <img class="lazy-image mn-origami-rail-card__image-pile mt2 loaded" alt="Amazon" height="40" width="40" src="https://media.licdn.com/dms/image/C4D0BAQHi-82ItMq_9g/company-logo_100_100/0?e=1553126400&amp;v=beta&amp;t=0BvJDwj04D93AuwH6CwzPn-v2TxOb1Yg0whuvAvdjGo">
                        <img class="lazy-image mn-origami-rail-card__image-pile mt2 loaded" alt="Mizuho" height="40" width="40" src="https://media.licdn.com/dms/image/C4E0BAQFYXr_iOlpo4w/company-logo_100_100/0?e=1553126400&amp;v=beta&amp;t=-28rSYdCkeUjrqyDvJvwvWPJWsdBgm7uNVc2Dkb4Fes">
                        <img class="lazy-image mn-origami-rail-card__image-pile mt2 loaded" alt="GE" height="40" width="40" src="https://media.licdn.com/dms/image/C4D0BAQHodefOcRRoYg/company-logo_100_100/0?e=1553126400&amp;v=beta&amp;t=wZPosvMOCHhOCmGPa3GeNIs8QWgB76ec3yV21-J0kgg">
                        <img class="lazy-image mn-origami-rail-card__image-pile mt2 loaded" alt="Investree" height="40" width="40" src="https://media.licdn.com/dms/image/C4D0BAQFBdNWKz2ywsA/company-logo_100_100/0?e=1553126400&amp;v=beta&amp;t=NBgS9NkDTI_QPAy4rLLDktoaLLLtcBjcUeb_GgzlGOU">
                      </div>
                    </a>        
                  </div>
                  <hr class="artdeco-divider mv0">
                  <div class="mn-origami-rail-card__summary">
                    <a data-control-name="hashtags" href="/feed/following/?filterType=channel" id="ember915" class="js-mn-origami-rail-card__hashtag-count link-without-hover-state ember-view">              
                      <h3 class="mn-origami-rail-card__count t-20 t-black t-normal" aria-label="See 1 hashtag you follow">
                        1
                      </h3>
                    </a>
                    <h3 class="t-16 t-black t-normal" aria-hidden="true">
                    ...
                    <a data-control-name="feed-following" href="/feed/following/?filterType=channel" id="ember916" class="link-without-hover-state text-align-center ember-view">              
                      <div>
                        <img class="lazy-image mn-origami-rail-card__image-pile mt2" alt="#cloudcomputing" height="40" width="40">
                      </div>
                    </a>        
                  </div>
                </section>
            ...
            <hr class="artdeco-divider mv0">
            <div id="ember735" class="ember-view">      
              <div id="ember792" class="ember-view">
                <section id="ember793" class="mn-abi-form ember-view">
                  <section class="full-width" role="main">
                    <div class="mn-abi-form__container " tabindex="-1">
                      <div>
                        <div class="mn-abi-form__content--promo ph3">
                          <h2 class="t-14 t-black t-normal text-align-center mb4 ph3 ">
                              Add personal contacts
                          </h2>
                          <p class="t-12 t-black--light t-normal mb4">
                              We’ll store your contacts to help you and others connect. You choose who to connect to and who to invite.
                            <a tabindex="0" class="mn-abi-form__learn-more-consent-btn" data-ember-action="" data-ember-action-794="794">Learn more</a>
                          </p>
                          <label for="email" class="visually-hidden">Email addresses to invite</label>
                          <input aria-describedby="email-error" name="email" placeholder="Your email address" id="email" class="mn-abi-form__input ember-text-field ember-view" type="email">
                          <button id="start-abi" class="mn-abi-form__primary-btn button-secondary-medium mb2" data-ember-action="" data-ember-action-796="796">
                              Continue
                          </button>
                        </div>
                        <div id="ember798" class="ember-view">
                        </div>        
                        <div class="mn-abi-form__graphic">                          
                        </div>
                      </div>
                    </div>
                  </section>
          ...
          <section id="ember1006" class="mn-discovery-tabs ember-view">
            <div class="artdeco-scrolling-container">
              ...
              <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#hashtags">Hashtags</a></li>
              </ul>
            </div>
            <div class="tab-content">
              ...
              <div id="companies" class="tab-pane fade">
                <ul id="ember1046" class="js-mn-discovery-entity-list__company mn-discovery-entity-list ember-view">          
                  <li id="ember1518" class="mn-discovery-entity-card mn-discovery-entity-card--33%-width ember-view">
                    <div id="ember1519" class="ember-view">
                      <section id="ember1520" class="mn-discovery-company-card mn-discovery-company-card--center-align artdeco-card ember-view">
                        <div class="text-align-center flex-1">
                          <div class="text-align-center">
                            <a data-control-name="company_content" href="/company/17896493/" id="ember1521" class="mn-discovery-company-card__image-link ember-view">          
                              <img class="lazy-image mn-discovery-company-card__image EntityPhoto-square-7 loaded" alt="LokerHotel.com picture" src="https://media.licdn.com/dms/image/C560BAQE6durHvsNUVw/company-logo_400_400/0?e=1553126400&amp;v=beta&amp;t=atKxiAqOowv1rkQ-zOW0j9mwK40SHaM52tSel13q1kU">
                            </a>
                            <a data-control-name="company_content" href="/company/17896493/" id="ember1522" class="mn-discovery-company-card__linkmn-discovery-company-card__link--center-align ember-view">          
                              <span class="visually-hidden">Company name</span>
                              <span class="mn-discovery-company-card__name t-14 t-black t-bold ">LokerHotel.com</span>
                              <span class="mn-discovery-company-card__followers t-12 t-black--light t-normal ">71,660 Followers</span>
                            </a>      
                          </div>
                          <div class="member-insights member-insights--discovery-card-center-align">
                            <span class="member-insights__reason pl1 t-12 t-black--light t-normal">Based on your profile</span>
                          </div>
                        </div>
                        <footer class="mt2 mhA text-align-center">
                          <button data-control-name="follow" aria-label="Follow company LokerHotel.com" id="ember1524" class="js-mn-discovery-company-card__action-btn mn-discovery-company-card__action-btn--extra-padding artdeco-button artdeco-button--1 artdeco-button--secondary ember-view">
                  ...
                  <li id="ember1526" class="mn-discovery-entity-card mn-discovery-entity-card--33%-width ember-view">
                    <div id="ember1527" class="ember-view">
                      <section id="ember1528" class="mn-discovery-company-card mn-discovery-company-card--center-align artdeco-card ember-view">
                        <div class="text-align-center flex-1">
                          <div class="text-align-center">
                            <a data-control-name="company_content" href="/company/13713/" id="ember1529" class="mn-discovery-company-card__image-link ember-view">          
                              <img class="lazy-image mn-discovery-company-card__image EntityPhoto-square-7 loaded" alt="PT HM Sampoerna Tbk. picture" src="https://media.licdn.com/dms/image/C4E0BAQG7aYfZ8-kirA/company-logo_400_400/0?e=1553126400&amp;v=beta&amp;t=PXz6JFTKqPR0IbrtWMVZlIyT8H1tM52YE6iJm27PqbY">
                            </a>
                            <a data-control-name="company_content" href="/company/13713/" id="ember1530" class="mn-discovery-company-card__linkmn-discovery-company-card__link--center-align ember-view">          
                              <span class="visually-hidden">Company name</span>
                              <span class="mn-discovery-company-card__name t-14 t-black t-bold ">PT HM Sampoerna Tbk.</span>
                              <span class="mn-discovery-company-card__followers t-12 t-black--light t-normal ">160,430 Followers</span>
                            </a>      
                          </div>
                          <div class="member-insights member-insights--discovery-card-center-align">
                            <span class="member-insights__reason pl1 t-12 t-black--light t-normal">People in your community follow</span>
                          </div>
                        </div>
                        <footer class="mt2 mhA text-align-center">
                          <button data-control-name="follow" aria-label="Follow company PT HM Sampoerna Tbk." id="ember1532" class="js-mn-discovery-company-card__action-btn mn-discovery-company-card__action-btn--extra-padding artdeco-button artdeco-button--1 artdeco-button--secondary ember-view">
                            <span class="artdeco-button__text">Follow</span>
                          </button>
                        </footer>
                      </section>
                  ...
                  <li id="ember1534" class="mn-discovery-entity-card mn-discovery-entity-card--33%-width ember-view">
                    <div id="ember1535" class="ember-view">
                      <section id="ember1536" class="mn-discovery-company-card mn-discovery-company-card--center-align artdeco-card ember-view">
                        <div class="text-align-center flex-1">
                          <div class="text-align-center">
                            <a data-control-name="company_content" href="/company/13468002/" id="ember1537" class="mn-discovery-company-card__image-link ember-view">          
                              <img class="lazy-image mn-discovery-company-card__image EntityPhoto-square-7 loaded" alt="LokerInd picture" src="https://media.licdn.com/dms/image/C560BAQHzkwTjtJ3RgA/company-logo_400_400/0?e=1553126400&amp;v=beta&amp;t=6Duh56KObQZhb4mBaPENNapOr9Zmw0J1QEyag4q3PvA">
                            </a>
                            <a data-control-name="company_content" href="/company/13468002/" id="ember1538" class="mn-discovery-company-card__linkmn-discovery-company-card__link--center-align ember-view">          <span class="visually-hidden">Company name</span>
                              <span class="mn-discovery-company-card__name t-14 t-black t-bold ">LokerInd</span>
                              <span class="mn-discovery-company-card__followers t-12 t-black--light t-normal ">57,796 Followers</span>
                            </a>      
                          </div>
                          <div class="member-insights member-insights--discovery-card-center-align">
                            <span class="member-insights__reason pl1 t-12 t-black--light t-normal">Based on your profile</span>
                        ...
                        <footer class="mt2 mhA text-align-center">
                          <button data-control-name="follow" aria-label="Follow company LokerInd" id="ember1540" class="js-mn-discovery-company-card__action-btn mn-discovery-company-card__action-btn--extra-padding artdeco-button artdeco-button--1 artdeco-button--secondary ember-view">
                            <span class="artdeco-button__text">Follow</span>
                          </button>
                        </footer>
                      </section>
              ...
              <div id="hashtags" class="tab-pane fade">
                <ul id="ember1048" class="js-mn-discovery-entity-list__hashtag mn-discovery-entity-list ember-view">          
                  <li id="ember1599" class="mn-discovery-entity-card mn-discovery-entity-card--33%-width ember-view">
                    <div id="ember1600" class="ember-view">
                      <section id="ember1601" class="mn-discovery-hashtag-card mn-discovery-hashtag-card--center-align artdeco-card ember-view">
                        <div class="text-align-center flex-1">
                          <div class="text-align-center">
                            <a data-control-name="hashtag_content" href="/feed/hashtag/culture/" id="ember1602" class="mn-discovery-hashtag-card__image-link ember-view"> 
                              <img class="lazy-image mn-discovery-hashtag-card__image EntityPhoto-square-7 loaded" alt="#culture picture" src="https://media.licdn.com/dms/image/C4E1AAQGnn_xPv6TpXg/storylineheaderimage-shrink_400_400/0?e=1545141600&amp;v=beta&amp;t=4GN_gZwsh-R1RwYNUNC0l4IBnutx8iscpOnUWrvE1Ds">
                            </a>
                            <a data-control-name="hashtag_content" href="/feed/hashtag/culture/" id="ember1603" class="mn-discovery-hashtag-card__link mn-discovery-hashtag-card__link--center-align ember-view">            
                              <span class="visually-hidden">Hashtag topic</span>
                              <span class="mn-discovery-hashtag-card__topic t-14 t-black t-bold ">#culture</span>
                              <span class="mn-discovery-hashtag-card__followers t-12 t-black--light t-normal ">3,709,666 Followers</span>
                            </a>      
                          </div>
                          <div class="member-insights member-insights--discovery-card-center-align">
                            <span class="member-insights__reason pl1 t-12 t-black--light t-normal">Popular in the Banking industry</span>
                          </div>
                        </div>
                        <footer class="mt2 mhA text-align-center">
                          <button data-control-name="follow" aria-label="Follow hashtag #culture" id="ember1605" class="js-mn-discovery-hashtag-card__action-btn mn-discovery-hashtag-card__action-btn--extra-padding artdeco-button artdeco-button--1 artdeco-button--secondary ember-view">
                            <span class="artdeco-button__text">Follow</span>
                          </button>
                        </footer>
                      </section>
                  ...
                  <li id="ember1607" class="mn-discovery-entity-card mn-discovery-entity-card--33%-width ember-view">
                    <div id="ember1608" class="ember-view">
                      <section id="ember1609" class="mn-discovery-hashtag-card mn-discovery-hashtag-card--center-align artdeco-card ember-view">
                        <div class="text-align-center flex-1">
                          <div class="text-align-center">
                            <a data-control-name="hashtag_content" href="/feed/hashtag/pengembangankarier/" id="ember1610" class="mn-discovery-hashtag-card__image-link ember-view">            
                              <img class="lazy-image mn-discovery-hashtag-card__image EntityPhoto-square-7 ghost-hashtag loaded" alt="#pengembangankarier picture" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">
                            </a>
                            <a data-control-name="hashtag_content" href="/feed/hashtag/pengembangankarier/" id="ember1611" class="mn-discovery-hashtag-card__link mn-discovery-hashtag-card__link--center-align ember-view">            
                              <span class="visually-hidden">Hashtag topic</span>
                              <span class="mn-discovery-hashtag-card__topic t-14 t-black t-bold ">#pengembangankarier</span>
                              <span class="mn-discovery-hashtag-card__followers t-12 t-black--light t-normal ">3,221 Followers</span>
                            </a>      
                          </div>
                          <div class="member-insights member-insights--discovery-card-center-align">
                            <span class="member-insights__reason pl1 t-12 t-black--light t-normal">Based on your recent activity</span>
                          </div>
                        </div>
                        <footer class="mt2 mhA text-align-center">
                          <button data-control-name="follow" aria-label="Follow hashtag #pengembangankarier" id="ember1613" class="js-mn-discovery-hashtag-card__action-btn mn-discovery-hashtag-card__action-btn--extra-padding artdeco-button artdeco-button--1 artdeco-button--secondary ember-view">
                            <span class="artdeco-button__text">Follow</span>
                          </button>
                        </footer>
                      </section>
                  ...
                  <li id="ember1615" class="mn-discovery-entity-card mn-discovery-entity-card--33%-width ember-view">
                    <div id="ember1616" class="ember-view">
                      <section id="ember1617" class="mn-discovery-hashtag-card mn-discovery-hashtag-card--center-align artdeco-card ember-view">
                        <div class="text-align-center flex-1">
                          <div class="text-align-center">
                            <a data-control-name="hashtag_content" href="/feed/hashtag/jobinterviews/" id="ember1618" class="mn-discovery-hashtag-card__image-link ember-view">            
                              <img class="lazy-image mn-discovery-hashtag-card__image EntityPhoto-square-7 loaded" alt="#jobinterviews picture" src="https://media.licdn.com/dms/image/C4E1AAQHhzpf8yMWW0w/storylineheaderimage-shrink_400_400/0?e=1545141600&amp;v=beta&amp;t=0yMgxm8t4oW-CmhCSiJMnaB2jJL9a22434Eb1yoIBFU">
                            </a>
                            <a data-control-name="hashtag_content" href="/feed/hashtag/jobinterviews/" id="ember1619" class="mn-discovery-hashtag-card__link mn-discovery-hashtag-card__link--center-align ember-view">            
                              <span class="visually-hidden">Hashtag topic</span>
                              <span class="mn-discovery-hashtag-card__topic t-14 t-black t-bold ">#jobinterviews</span>
                              <span class="mn-discovery-hashtag-card__followers t-12 t-black--light t-normal ">12,921,243 Followers</span>
                            </a>      
                          </div>
                          <div class="member-insights member-insights--discovery-card-center-align">
                            <span class="member-insights__reason pl1 t-12 t-black--light t-normal">People in your community follow this</span>
                          </div>
                        </div>
                        <footer class="mt2 mhA text-align-center">
                          <button data-control-name="follow" aria-label="Follow hashtag #jobinterviews" id="ember1621" class="js-mn-discovery-hashtag-card__action-btn mn-discovery-hashtag-card__action-btn--extra-padding artdeco-button artdeco-button--1 artdeco-button--secondary ember-view">
                            <span class="artdeco-button__text">Follow</span>
                          </button>
                        </footer>
                      </section>
