    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="{{ route('home') }}">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{ route('blog') }}"> Blog Posts</a></p>
            </div>											
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 post-list blog-post-list">
                ...
                <div class="single-post">
                    <img class="img-fluid" src="{{ asset('public/themes/img/blog/p2.jpg') }}" alt="">
                    <ul class="tags">
                        <li><a href="#">Art, </a></li>
                        <li><a href="#">Technology, </a></li>
                        <li><a href="#">Fashion</a></li>
                ...
                <div class="single-post">
                    <img class="img-fluid" src="{{ asset('public/themes/img/blog/p3.jpg') }}" alt="">
                    <ul class="tags">
                        <li><a href="#">Art, </a></li>
                        <li><a href="#">Technology, </a></li>
                        <li><a href="#">Fashion</a></li>
                ...
                <div class="single-post">
                    <img class="img-fluid" src="{{ asset('public/themes/img/blog/p4.jpg') }}" alt="">
                    <ul class="tags">
                        <li><a href="#">Art, </a></li>
                        <li><a href="#">Technology, </a></li>
                        <li><a href="#">Fashion</a></li>
