    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="{{ route('home') }}">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{ route('job') }}"> Job post</a></p>
            </div>											
        </div>
    </div>
</section>
                ...
                <div class="single-post d-flex flex-row">
                    ...
                    <div class="details">
                        <div class="title d-flex flex-row justify-content-between">
                            <div class="titles">
                                <a href="{{ route('jobDetail') }}"><h4>Creative Art Designer</h4></a>
                ...
                <div class="single-slidebar">
                    ...
                    <div class="blog-list">
                        <div class="single-blog " style="background:#000 url(public/themes/img/blog1.jpg);">
                            <a href="{{ route('jobDetail') }}"><h4>Home Audio Recording <br>
                            For Everyone</h4></a>
